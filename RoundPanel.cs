...
namespace Gerenciamento_de_Dietas
{
    public class CustomPanel : System.Windows.Forms.Panel
    {
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillRoundedRectangle(new SolidBrush(this.ForeColor), 10, 10, this.Width - 40, this.Height - 60, 10);
            SolidBrush brush = new SolidBrush(
                this.ForeColor
                );
            g.FillRoundedRectangle(brush, 12, 12, this.Width - 44, this.Height - 64, 10);
            g.DrawRoundedRectangle(new Pen(ControlPaint.Light(this.ForeColor, 0.00f)), 12, 12, this.Width - 44, this.Height - 64, 10);
            g.FillRoundedRectangle(new SolidBrush(this.ForeColor), 12, 12 + ((this.Height - 64) / 2), this.Width - 44, (this.Height - 64) / 2, 10);
        }
    }
